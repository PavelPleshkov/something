...
const createLink_dto_1 = require("./createLink.dto");
let LinksController = class LinksController {
    async findAll(isInner, color) {
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('isInner')),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [createLink_dto_1.CreateLinkDto]),
    __metadata("design:returntype", Promise)
